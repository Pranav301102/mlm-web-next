      ...
      <div className="container mx-auto px-6 py-12">
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="prose max-w-none">
            ...
            <p className="mb-4 text-gray-700 leading-relaxed">It does not apply to information collected by:</p>
            <ul className="list-disc pl-6 mb-6 text-gray-700">
            ...
            <p className="mb-4 text-gray-700 leading-relaxed">We collect this information:</p>
            ...
            <p className="mb-4 text-gray-700 leading-relaxed">The information we collect on or through our Digital Services is:</p>
            <ul className="list-disc pl-6 mb-6 text-gray-700">
            ...
            <p className="mb-8 text-gray-700 leading-relaxed">
              If you would like to be deleted from our service, you can submit a request to info@mumslike.me. This will remove you from all newsletters you are subscribed to using the Mums Like Me platform.
            </p>

            <h2 className="text-2xl font-bold text-gray-900 mb-4">4. How We Use Your Information</h2>
            <p className="mb-4 text-gray-700 leading-relaxed">We use information that we collect about you or that you provide to us, including any Personal Data:</p>
            <ul className="list-disc pl-6 mb-6 text-gray-700">
            ...
            <p className="mb-4 text-gray-700 leading-relaxed">We will not discriminate against you for exercising any of your CCPA rights. Unless permitted by the CCPA, we will not:</p>
            <ul className="list-disc pl-6 mb-8 text-gray-700">
