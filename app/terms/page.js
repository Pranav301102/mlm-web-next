    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-400 via-pink-500 to-purple-600">
      <div className="container mx-auto px-6 py-12">
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8">
          ...
          <p className="text-gray-600 mb-8 text-center">Last updated: Aug 24, 2025</p>
          ...
          <div className="prose max-w-none">
            ...
            <p className="mb-8 text-gray-700 leading-relaxed">
              Mums Like Me is offered and available to users who are 16 years of age or older. By using Mums Like Me, you represent and warrant that you are of legal age to form a binding contract with us and meet all of the foregoing eligibility requirements. If you do not meet all of these requirements, you must not access or use Mums Like Me.
            </p>

            <h2 className="text-2xl font-bold text-gray-900 mb-4">Changes to the Terms of Use</h2>
            <p className="mb-8 text-gray-700 leading-relaxed">
              We may revise and update these Terms of Use from time to time in our sole discretion. All changes are effective immediately when we post them, and apply to all access to and use of Mums Like Me thereafter.
            </p>
            <p className="mb-8 text-gray-700 leading-relaxed">
              Your continued use of Mums Like Me following the posting of revised Terms of Use means that you accept and agree to the changes. You are expected to check this page from time to time so you are aware of any changes, as they are binding on you.
            </p>

            <h2 className="text-2xl font-bold text-gray-900 mb-4">Accessing Mums Like Me and Account Security</h2>
            <p className="mb-6 text-gray-700 leading-relaxed">
              We reserve the right to change any service or functionality we provide on Mums Like Me, in our sole discretion without notice. We will not be liable if for any reason all or any part of Mums Like Me is unavailable at any time or for any period. From time to time, we may restrict access to some parts of Mums Like Me to users, including registered users.
            </p>
            <p className="mb-4 text-gray-700 leading-relaxed">You are responsible for both:</p>
            <ul className="list-disc pl-6 mb-6 text-gray-700">
              <li>Making all arrangements necessary for you to have access to Mums Like Me.</li>
              <li>Ensuring that all persons who access Mums Like Me through your internet connection are aware of these Terms of Use and comply with them.</li>
            </ul>
            <p className="mb-6 text-gray-700 leading-relaxed">
              To access Mums Like Me or some of the resources it offers, you may be asked to provide certain registration details. It is a condition of your use of Mums Like Me that all the information you provide on Mums Like Me is correct, current, and complete. You agree that all information you provide to register with Mums Like Me or otherwise, including, but not limited to, through the use of any interactive features on Mums Like Me, is governed by our Privacy Policy, and you consent to all actions we take with respect to your information consistent with our Privacy Policy.
            </p>
            <p className="mb-8 text-gray-700 leading-relaxed">
              If you choose, or are provided with, a user name, password, or any other piece of information as part of our security procedures, you must treat such information as confidential, and you must not disclose it to any other person or entity. You also acknowledge that your account is personal to you and agree not to provide any other person with access to Mums Like Me or portions of it using your user name, password, or other security information. You agree to notify us immediately of any unauthorized access to or use of your user name or password or any other breach of security. You also agree to ensure that you exit from your account at the end of each session. You should use particular caution when accessing your account from a public or shared computer so that others are not able to view or record your password or other personal information.
            </p>
            <p className="mb-8 text-gray-700 leading-relaxed">
            ...
            <ul className="list-disc pl-6 mb-6 text-gray-700 leading-relaxed">
              ...
              <li>Terminate or suspend your access to all or part of Mums Like Me for any or no reason, including without limitation, any violation of these Terms of Use.</li>
              <li>With respect to any customer that has been blocked or removed from the Mums Like Me platform, withhold any Ad Network and/or Boosts earnings.</li>
            </ul>
            <p className="mb-8 text-gray-700 leading-relaxed">
              Without limiting the foregoing, we have the right to cooperate fully with any law enforcement authorities or court order requesting or directing us to disclose the identity or other information of anyone publishing content on or through Mums Like Me. YOU WAIVE AND HOLD HARMLESS Mums Like Me AND ITS AFFILIATES, LICENSEES, AND SERVICE PROVIDERS FROM ANY CLAIMS RESULTING FROM ANY ACTION TAKEN BY ANY OF THE FOREGOING PARTIES DURING, OR TAKEN AS A CONSEQUENCE OF, INVESTIGATIONS BY EITHER SUCH PARTIES OR LAW ENFORCEMENT AUTHORITIES.
            </p>
            <p className="mb-8 text-gray-700 leading-relaxed">
              However, we do not undertake to review content before it is published on Mums Like Me, and cannot ensure prompt removal of objectionable content after it has been published. Accordingly, we assume no liability for any action or inaction regarding transmissions, communications, or content provided by any user or third party. We have no liability or responsibility to anyone for performance or nonperformance of the activities described in this section.
            </p>
